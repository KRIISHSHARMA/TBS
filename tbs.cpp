...
private:
    ...
    double R64QAM[32] = {120,157,193,251,308,379,449,526,602,679,340,378,434,490,553,616,658,438,466,517,567,616,666,719,772,822,873,910,948,0,0,0};
    double R256QAM[32] = {120,193,308,449,602,378,434,490,553,616,658,466,517,567,616,666,719,772,822,873,682.5,711,754,797,841,885,916.5,948,0,0,0,0};
...
public:
    void calculatePDSCH() {
        ...
        double Code_Rate = getCodeRate(MCS_Table, MCS_Index);
...
// DMRS CONFIG
        ...
        double N_info = NRE * Code_Rate * Modulation_order * numlayers;
...
private:
    ...
    double getCodeRate(int table, int index) {
        if (table == 0) {
